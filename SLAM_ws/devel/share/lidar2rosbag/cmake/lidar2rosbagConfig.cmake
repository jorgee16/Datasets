...
if(lidar2rosbag_CONFIG_INCLUDED)
  return()
endif()
set(lidar2rosbag_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(lidar2rosbag_SOURCE_PREFIX /home/joaojorge/SLAM_ws/src/lidar2rosbag_KITTI)
  set(lidar2rosbag_DEVEL_PREFIX /home/joaojorge/SLAM_ws/devel)
  set(lidar2rosbag_INSTALL_PREFIX "")
  set(lidar2rosbag_PREFIX ${lidar2rosbag_DEVEL_PREFIX})
else()
  set(lidar2rosbag_SOURCE_PREFIX "")
  set(lidar2rosbag_DEVEL_PREFIX "")
  set(lidar2rosbag_INSTALL_PREFIX /home/joaojorge/SLAM_ws/install)
  set(lidar2rosbag_PREFIX ${lidar2rosbag_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'lidar2rosbag' is deprecated")
...
set(lidar2rosbag_FOUND_CATKIN_PROJECT TRUE)
...
if(NOT "/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/opencv4 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${lidar2rosbag_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lidar2rosbag' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'lidar2rosbag' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joaojorge/SLAM_ws/src/lidar2rosbag_KITTI/${idir}'.  ${_report}")
    endif()
    _list_append_unique(lidar2rosbag_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND lidar2rosbag_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND lidar2rosbag_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT lidar2rosbag_NUM_DUMMY_TARGETS)
      set(lidar2rosbag_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lidar2rosbag::wrapped-linker-option${lidar2rosbag_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lidar2rosbag_NUM_DUMMY_TARGETS "${lidar2rosbag_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lidar2rosbag::wrapped-linker-option${lidar2rosbag_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lidar2rosbag_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(lidar2rosbag_LIBRARY_DIRS ${lib_path})
      list(APPEND lidar2rosbag_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'lidar2rosbag'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND lidar2rosbag_LIBRARIES ${lib})
    endif()
  endif()
...
set(lidar2rosbag_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${lidar2rosbag_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "geometry_msgs;nav_msgs;roscpp;rospy;std_msgs;rosbag_storage")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 lidar2rosbag_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${lidar2rosbag_dep}_FOUND)
      find_package(${lidar2rosbag_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lidar2rosbag_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(lidar2rosbag_INCLUDE_DIRS ${${lidar2rosbag_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(lidar2rosbag_LIBRARIES ${lidar2rosbag_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${lidar2rosbag_dep}_LIBRARIES})
  _list_append_deduplicate(lidar2rosbag_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(lidar2rosbag_LIBRARIES ${lidar2rosbag_LIBRARIES})

  _list_append_unique(lidar2rosbag_LIBRARY_DIRS ${${lidar2rosbag_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(lidar2rosbag_EXPORTED_TARGETS ${${lidar2rosbag_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${lidar2rosbag_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
