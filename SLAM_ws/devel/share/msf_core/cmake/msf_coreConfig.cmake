...
if("TRUE" STREQUAL "TRUE")
  set(msf_core_SOURCE_PREFIX /home/joaojorge/SLAM_ws/src/ethzasl_msf/msf_core)
  set(msf_core_DEVEL_PREFIX /home/joaojorge/SLAM_ws/devel)
  set(msf_core_INSTALL_PREFIX "")
  set(msf_core_PREFIX ${msf_core_DEVEL_PREFIX})
else()
  set(msf_core_SOURCE_PREFIX "")
  set(msf_core_DEVEL_PREFIX "")
  set(msf_core_INSTALL_PREFIX /home/joaojorge/SLAM_ws/install)
...
if(NOT "/home/joaojorge/SLAM_ws/devel/include;/home/joaojorge/SLAM_ws/src/ethzasl_msf/msf_core/include;/usr/include/eigen3 " STREQUAL " ")
  set(msf_core_INCLUDE_DIRS "")
  set(_include_dirs "/home/joaojorge/SLAM_ws/devel/include;/home/joaojorge/SLAM_ws/src/ethzasl_msf/msf_core/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'msf_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joaojorge/SLAM_ws/src/ethzasl_msf/msf_core/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;sensor_msgs;nav_msgs;dynamic_reconfigure;msf_timing;tf")
...
set(pkg_cfg_extras "/home/joaojorge/SLAM_ws/src/ethzasl_msf/msf_core/cmake/export_flags.cmake")
